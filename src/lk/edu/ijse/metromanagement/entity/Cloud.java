...
public class Cloud {
    ...
    public Cloud(String cloudID, int lcAmount, String lcFrom, int lcDirection, int mcAmount, String mcFrom, int mcDirection, int hcAmount, String hcFrom, int hcDirection, int sgAmount, int sgForm, int sgHeight, int totalAmount, String wetherID) {
