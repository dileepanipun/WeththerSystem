...
public class SeaStateDTO {
    ...
    public SeaStateDTO(String seaStateID, String seaCodeFigure, String swellCodeFigure, int wValue, int w1Value, int wwValue, String wetherID) {
