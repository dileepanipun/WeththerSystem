...
public class HumidityDTO {
    ...
    public HumidityDTO(String humidityID, int vpCurrent, int vpMaxTemps, int vpMinTemps, int rhCurrent, int rhMaxTemps, int rhMinTemps, String visibility, String wetherID) {
    ...
    public String toString() {
        return "HumidityDTO{" +
                ...
                ", vpCurrent=" + vpCurrent +
                ", vpMaxTemps=" + vpMaxTemps +
                ", vpMinTemps=" + vpMinTemps +
                ", rhCurrent=" + rhCurrent +
                ", rhMaxTemps=" + rhMaxTemps +
                ", rhMinTemps=" + rhMinTemps +
