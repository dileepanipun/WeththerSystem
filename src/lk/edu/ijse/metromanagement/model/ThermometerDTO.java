...
public class ThermometerDTO {
    ...
    public String toString() {
        return "ThermometerDTO{" +
                ...
                ", arMinDry=" + arMinDry +
                ", arMinWet=" + arMinWet +
                ", arMinOnGrass=" + arMinOnGrass +
                ", sftRestMaxDry=" + sftRestMaxDry +
                ", sftRestMaxWet=" + sftRestMaxWet +
                ", icCurDry=" + icCurDry +
                ", icCurWet=" + icCurWet +
                ", icMaxDry=" + icMaxDry +
                ", icMaxWet=" + icMaxWet +
                ", icMinDry=" + icMinDry +
                ", icMinWet=" + icMinWet +
                ", icMinOnGrass=" + icMinOnGrass +
                ", dpCurTemp=" + dpCurTemp +
                ", dpMaxTemps=" + dpMaxTemps +
                ", dpMinTemps=" + dpMinTemps +
                ", wetherID='" + wetherID + '\'' +
                '}';
    }
}
